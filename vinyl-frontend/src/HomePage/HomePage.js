        ...
        <section className="hero">
            <div className="container hero-container">
                <Link to="#" className="hero-link">
                    <img className="hero-img" src="https://3345rpm.ru/image/cache/catalog/demo/adverty/ADV_HPR010_-auto_width_450.png" alt="hero img"/>
                </Link>
            </div>
        </section>
                    ...
                    <ul className="music-catalog-list">
                        <li className="music-catalog-item">
                            <Link to="#" className="music-catalog-link">
                                <img src="https://3345rpm.ru/image/cache/catalog/Releases/NMS005.2/NMS0052-auto_width_266.jpg" alt="Фото пластинки" className="music-catalog-img"/>
